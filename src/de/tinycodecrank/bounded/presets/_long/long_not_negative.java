 ...
 */
public final class long_not_negative implements BoundedLong
{
	private final long value;
	
	private long_not_negative(long value)
	{
		this.value = value;
	}
	...
	private static final BoundedLongBuilder<long_not_negative> builder = new BoundedLongBuilder<>(
		long_not_negative::validate,
		long_not_negative::new,
		long_not_negative::createError);
	
	public static BoundedLongBuilder<long_not_negative> builder()
	{
		return builder;
	}
}